...
IL_Tracts_geom <- tracts(c("IL"), cb=TRUE, class="sf")
IL_Places_geom <- places(c("IL"), cb=TRUE, class="sf")
IL_Counties_geom <- counties(c("IL"), cb=TRUE, class="sf")
IL_Tracts_geom <- st_transform(IL_Tracts_geom, crs = 3435)
...
st_write(IL_Counties_geom,"layers/IL_Counties_geom.shp", append = FALSE)
st_write(IL_Places_geom,"layers/IL_Places_geom.shp", append = FALSE)
st_write(IL_Tracts_geom,"layers/IL_Tracts_geom.shp", append = FALSE)
